...
public class BankAccountServiceImpl implements BankAccountService{
    ...
    @Override
    public BankAccountResponse updateBankAccount(Long id, BankAccountResponse bankAccountResponse) {
        return null;
    }
    ...
    public void deleteBankAccount(Long id) {
        ...
        var account = bankAccountRepository.findById(id).orElseThrow(() -> new BankAccountNotFound(id));
    ...
    private String generateIban() {
        String countryCode = "ES"; // Código de país
